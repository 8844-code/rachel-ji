...
> **状态：当前已上线版本。** 本文对应 `01 开发/index.html` 的 Creator / Builder 入口结构。
>
> `00 设计/(C)新版设计规格.md` 是尚未实施的“RJ's Bar”新版提案。旧站文案、图片与作品资料必须保留，供新版建设时筛选复用。
...
| 2026-07-31 | 修正：网站对外主线为 QKids 线上英语老师；Preply 是中文教学补充，不作为当前英语教学经历展示 |
